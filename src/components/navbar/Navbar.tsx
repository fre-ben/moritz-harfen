...
const Navbar = () => {
  ...
  const MobileNavItems = (
    <Transition
      ...
      leaveTo="opacity-0"
    >
      <Menu.Items className="absolute right-0 top-18 sm:top-20 justify-items-end w-full pt-6 pb-8 bg-background grid grid-flow-row gap-y-4 max-h-screen overflow-scroll overflow-x-hidden">
        <Menu.Item>
