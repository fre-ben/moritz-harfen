      ...
      <Content flow="row" headline="werkstatt">
        <div className="lg:pl-20 md:w-7/12 lg:w-9/12">
          <p className="mb-4">
            ...
            Jahre ins nahegelegene Haunetal umzog, entstanden. Am 4.4.2018
            verstarb Albrecht und eine Nachfolge war zunächst ungewiss.
          </p>
          <p className="mb-4">
            Im Jahr 2020 wurde die Werkstatt von dem Instrumentenbauer Moritz
            Dortmund übernommen. Moritz hat das Schreinerhandwerk in
            ...
            dazu, die Werkstatt zu übernehmen. Claudia Uecker, Albrechts Frau,
            führt dabei das Leihharfengeschäft weiter. So wird Albrecht Nüchters
            Fackel weitergetragen und es entstehen in dieser Werkstatt weiterhin
            hochwertige, handwerklich gefertigte Harfen.
          </p>
          <p className="mb-4">
            Die Instrumente werden ausschließlich aus heimischen Hölzern
